...
app.get("/", async function(req, res){
    ...
    let apiUrl = `https://api.unsplash.com/photos/random/?client_id=DdPWWfHswK1EKCCh2OQOlCAzyVYI_WPza1jOXDQ-m_0&featured=true&orientation=landscape`;
...
app.get("/search", async function(req, res){
    ...
    let apiUrl = `https://api.unsplash.com/photos/random/?count=9&client_id=DdPWWfHswK1EKCCh2OQOlCAzyVYI_WPza1jOXDQ-m_0&featured=true&orientation=landscape&query=${keyword}`;
    let response = await fetch(apiUrl);
    let data = await response.json();
